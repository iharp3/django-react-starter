...
--------------------------
             ...
             Code V2:
              - has three sections in bottom panel
              - has dropdown menu for different plots
              - TODO: fix index of plots so each one is independent of the others and each 
                window initially displays a different plot
              - has specific buttons within the plot
...
--------------------------
              ...
              Code V1:
              - has three sections in the bottom panel
              - has all plot options as tabs
              - has specific plot buttons in each panel
